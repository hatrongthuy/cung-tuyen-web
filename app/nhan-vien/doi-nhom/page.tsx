...
export default async function DoiNhomNhanVienPage() {
  ...
  const ctx = { nam, thang, ngay, monthStartMs, nowMs, lastMonthStartMs, lastMonthSameMs, lastMonthLabel };
    ...
    <>
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 py-6">
        <DoiNhomView
          ...
          tonDong={tonDong}
          ctx={ctx}
          onlyMa={user.maNhanVien ?? undefined}
          title="Kết quả & việc cần làm của tôi"
        />
      </main>
    </>
  );
